...
RT_TRACKS = {
    "08/1AE1A7D894960B38E09E7494373378D87305A163": [-1],        # LC                   Circuito di Luigi
    "01/90720A7D57A7C76E2347782F6BDE5D22342FB7DD": [-1],        # MMM                  Prateria verde
    "02/0E380357AFFCFD8722329994885699D9927F8276": [18, 1],     # MG    (NO-SC+SC/G)   Gola Fungo
    "04/1896AEA49617A571C66FF778D8F2ABBE9E5D7479": [2, 16],     # TF    (NO-SC/SC)     Fabbrica di Toad
    "00/7752BB51EDBC4A95377C0A05B0E0DA1503786625": [0, 1],      # MC    (NO-SC/G)      Circuito di Mario
    "05/E4BF364CB0C5899907585D731621CA930A4EF85C": [2, 16, 1],  # CM    (NO-SC/SC/G)   Outlet Cocco
    "06/B02ED72E00B400647BDA6845BE387C47D251F9D1": [-1],        # DKSC                 Pista Snowboard DK
    "07/D1A453B43D6920A78565E65A4597E353B177ABD0": [0, 1],      # WGM   (NO-SC/G)      Miniera d'oro di Wario
    "09/72D0241C75BE4A5EBD242B9D8D89B1D6FD56BE8F": [-1],        # DC                   Circuito di Daisy
    "0F/52F01AE3AED1E0FA4C7459A648494863E83A548C": [0, 1],      # KC    (NO-SC/G)      Punta Koopa
    "0B/48EBD9D64413C2B98D2B92E5EFC9B15ECD76FEE6": [0, 1],      # MT    (NO-SC/G)      Pista degli aceri
    "03/ACC0883AE0CE7879C6EFBA20CFE5B5909BF7841B": [2, 16, 1],  # GV    (NO-SC/SC/G)   Vulcano brontolone
    "0E/38486C4F706395772BD988C1AC5FA30D27CAE098": [-1],        # DDR                  Rovine desertiche
    "0A/B13C515475D7DA207DFD5BADD886986147B906FF": [-1],        # MH                   Autostrada lunare
    "0C/B9821B14A89381F9C015669353CB24D7DB1BB25D": [2, 16],     # BC    (NO-SC/SC)     Castello di Bowser
    "0D/FFE518915E5FAAA889057C8A3D3E439868574508": [0, 1],      # RR    (NO-SC/G)      Pista Arcoblaleno
    "10/8014488A60F4428EEF52D01F8C5861CA9565E1CA": [0, 1],      # rPB   (NO-SC/G)      GCN Spiaggia di Peach
    "14/8C854B087417A92425110CC71E23C944D6997806": [-1],        # rYF                  DS Cascate di Yoshi
    "19/071D697C4DDB66D3B210F36C7BF878502E79845B": [0, 1],      # rGV2  (NO-SC/G)      SNES Valle fantasma 2
    "1A/49514E8F74FEA50E77273C0297086D67E58123E8": [-1],        # rMR                  N64 Pista di Mario
    "1B/BA9BCFB3731A6CB17DBA219A8D37EA4D52332256": [0, 1],      # rSL   (NO-SC/G)      N64 Circuito Gelato
    "1F/E8ED31605CC7D6660691998F024EED6BA8B4A33F": [0, 1],      # rSGB  (NO-SC/G)      GBA Spiaggia Tipo Timido
    "17/BC038E163D21D9A1181B60CF90B4D03EFAD9E0C5": [-1],        # rDS                  DS Borgo Delfino
    "12/418099824AF6BF1CD7F8BB44F61E3A9CC3007DAE": [0, 1],      # rWS   (NO-SC/G)      GCN Stadio di Waluigi
    "15/4EC538065FDC8ACF49674300CBDEC5B80CC05A0D": [2, 16],     # rDH   (NO-SC/SC)     DS Deserto Picchiasol
    "1E/A4BEA41BE83D816F793F3FAD97D268F71AD99BF9": [2, 16],     # rBC3  (NO-SC/SC)     GBA Castello di Bowser 3
    "1D/692D566B05434D8C66A55BDFF486698E0FC96095": [2, 16, 1],  # rDKJP (NO-SC/SC/G)   N64 Viale Giungla DK
    "11/1941A29AD2E7B7BBA8A29E6440C95EF5CF76B01D": [2, 16],     # rMC   (NO-SC/SC)     GCN Circuito di Mario
    "18/077111B996E5C4F47D20EC29C2938504B53A8E76": [-1],        # rMC3                 SNES Circuito di Mario 3
    "16/F9A62BEF04CC8F499633E4023ACC7675A92771F0": [-1],        # rPG                  DS Giardino di Peach
    "13/B036864CF0016BE0581449EF29FB52B2E58D78A4": [2, 16],     # rDKM  (NO-SC/SC)     GCN Montagne DK
    "1C/15B303B288F4707E5D0AF28367C8CE51CDEAB490": [2, 1],      # rBC   (NO-SC/G)      N64 Castello di Bowser
}
